...
namespace ISBNextractor
{
    ...
    public class Book : ListViewItem
    {
        ...
        private string path = "", isbn="", naslov = "", gizdanja ="",podnaslov = "", jezik = "", izdavac = "", abstrakt = "", stranica = "", izdanje = "", authors = "";
        ...
        public bool Save()
        {
            ...
            createBook(slikica, GetAuthors(), true);
        ...
        {
            string sUpit = "insert into katalog (naslov,podnaslov,isbn,izdavac,fk_jezik,broj_stranica,izdanje,autori,slika,sadrzaj,pubdate)" +
                            "values ('"
                            + naslov.Replace('\'', '`') + "','"
                            + podnaslov.Replace('\'', '`') + "','"
                            + isbn.Replace('\'', '`') + "',"
                            ...
                            + "ebook" + "','"
                            + authors.Replace('\'', '`') + "',?,'"
                            + abstrakt.Replace('\'', '`') + "','" + gizdanja.Replace('\'', '`') + "')";
       ...
       /*     if (path.Contains("pdf"))
        ...
        private void saveMeta(java.io.FileOutputStream fos, java.util.zip.ZipOutputStream zos)
        {
            ...
            // save as plain
             string plainMeta = 
                   "<Book><Items><Item><ItemAttributes>"+
                        "<Binding>eBook</Binding>" +
                        "<Author><![CDATA[" + GetAuthors() + "]]></Author>" +
                        "<Edition><![CDATA[" + izdanje + "]]></Edition>" +
			            "<ISBN>"+isbn+"</ISBN>"+
                        "<Manufacturer><![CDATA[" + izdavac + "]]></Manufacturer>" +
                        "<NumberOfPages>"+stranica+"</NumberOfPages>" +
			            "<PublicationDate>"+gizdanja+"</PublicationDate>"+
                        "<Publisher><![CDATA[" + izdavac + "]]></Publisher>" +
                        "<Title><![CDATA[" + naslov + ": " + podnaslov + "]]></Title>" +
                        "<Content><![CDATA[" + abstrakt + "]]></Content>" +
                 "</ItemAttributes></Item></Items></Book>";
